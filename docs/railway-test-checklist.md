...
3. Confirm the **RAI** explanation appears below, correctly describing it as an adaptation of the standard SDT scoring protocol (Grolnick & Ryan, 1989; Ryan & Connell, 1989; Vallerand, 2007; Ünlü, 2016) to SIMS's 4-subscale structure, which has no Introjected Regulation subscale — Amotivation substitutes as the opposite pole (corrected 2026-09-03; the earlier wording over-attributed the exact formula to Ryan & Connell alone, which doesn't survive a full read of that paper). Confirm a count like "X of Y (student, module) rows have all 4 SIMS sub-constructs present."
